...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected function customDiscoverEvents()
    {
        ...
        $namespace = 'Innoboxrr\LivewireComments\Http\Events\\';
    ...
    protected function customDiscoverObservers()
    {
        ...
        $namespaceModel = 'Innoboxrr\LivewireComments\Models\\';
        $namespaceObserver = 'Innoboxrr\LivewireComments\Observers\\';
